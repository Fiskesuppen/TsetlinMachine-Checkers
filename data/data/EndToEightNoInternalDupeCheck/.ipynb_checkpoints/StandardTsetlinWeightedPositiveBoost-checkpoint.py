...
def tsetlinStandardWeightedHandler(epochs, clauses, T, s, k_fold_amount):
    ...
    with open("StandardTsetlinWeightedLogPositiveBoostEndToEightNoIntDup.txt", "a+") as myfile:
...
tsetlinStandardWeightedHandler(500, 4000, 12000, 68, k_fold_amount)
tsetlinStandardWeightedHandler(500, 8000, 12000, 68, k_fold_amount)
tsetlinStandardWeightedHandler(500, 12000, 12000, 68, k_fold_amount)
tsetlinStandardWeightedHandler(500, 15000, 12000, 68, k_fold_amount)
tsetlinStandardWeightedHandler(500, 20000, 12000, 68, k_fold_amount)
tsetlinStandardWeightedHandler(500, 30000, 12000, 68, k_fold_amount)
tsetlinStandardWeightedHandler(500, 40000, 12000, 68, k_fold_amount)
tsetlinStandardWeightedHandler(500, 50000, 12000, 68, k_fold_amount)
