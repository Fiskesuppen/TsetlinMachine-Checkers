...
def tsetlinStandardWeightedHandler(epochs, clauses, T, s, k_fold_amount):
    ...
    with open("StandardTsetlinWeightedLogPositiveBoostEndToEight.txt", "a+") as myfile:
...
tsetlinStandardWeightedHandler(500, 15000, 40000, 68, k_fold_amount)
tsetlinStandardWeightedHandler(500, 15000, 80000, 68, k_fold_amount)
tsetlinStandardWeightedHandler(500, 15000, 160000, 68, k_fold_amount)
tsetlinStandardWeightedHandler(500, 15000, 300000, 68, k_fold_amount)
tsetlinStandardWeightedHandler(500, 15000, 800000, 68, k_fold_amount)
