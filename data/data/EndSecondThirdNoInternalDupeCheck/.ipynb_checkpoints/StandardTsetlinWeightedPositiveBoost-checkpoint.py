...
def tsetlinStandardWeightedHandler(epochs, clauses, T, s, k_fold_amount):
    ...
    with open("StandardTsetlinWeightedLogPositiveBoostEndSecondThirdNoIntDup.txt", "a+") as myfile:
...
tsetlinStandardWeightedHandler(500, 13000, 5000, 20, k_fold_amount)
tsetlinStandardWeightedHandler(500, 13000, 16000, 20, k_fold_amount)
tsetlinStandardWeightedHandler(500, 13000, 25000, 20, k_fold_amount)
tsetlinStandardWeightedHandler(500, 13000, 40000, 20, k_fold_amount)
tsetlinStandardWeightedHandler(500, 13000, 50000, 20, k_fold_amount)
tsetlinStandardWeightedHandler(500, 13000, 80000, 20, k_fold_amount)