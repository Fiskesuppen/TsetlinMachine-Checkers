...
def tsetlinStandardWeightedHandler(epochs, clauses, T, s, k_fold_amount):
    ...
    with open("StandardTsetlinWeightedLogPositiveBoostEndSecondThird.txt", "a+") as myfile:
...
tsetlinStandardWeightedHandler(500, 2500, 80000, 20, k_fold_amount)
tsetlinStandardWeightedHandler(500, 13000, 80000, 20, k_fold_amount)
tsetlinStandardWeightedHandler(500, 24000, 80000, 20, k_fold_amount)
tsetlinStandardWeightedHandler(500, 35000, 80000, 20, k_fold_amount)
tsetlinStandardWeightedHandler(500, 40000, 80000, 20, k_fold_amount)
tsetlinStandardWeightedHandler(500, 50000, 80000, 20, k_fold_amount)
