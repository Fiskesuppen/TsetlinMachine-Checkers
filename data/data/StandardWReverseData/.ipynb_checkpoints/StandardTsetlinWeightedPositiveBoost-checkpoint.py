...
def tsetlinStandardWeightedHandler(epochs, clauses, T, s, k_fold_amount):
    ...
    #acstr = str(accuracy)
    #with open("StandardTsetlinWeightedLogWMeta.txt", "a+") as myfile:
    with open("StandardTsetlinWeightedLogPositiveBoostWReverseData.txt", "a+") as myfile:
...
tsetlinStandardWeightedHandler(500, 15000, 4000, 15, k_fold_amount)
tsetlinStandardWeightedHandler(500, 15000, 7000, 15, k_fold_amount)
tsetlinStandardWeightedHandler(500, 15000, 12000, 15, k_fold_amount)
tsetlinStandardWeightedHandler(500, 15000, 16000, 15, k_fold_amount)
tsetlinStandardWeightedHandler(500, 15000, 25000, 15, k_fold_amount)
tsetlinStandardWeightedHandler(500, 15000, 30000, 15, k_fold_amount)
