...
def merging_k_fold(file_amount, _epochs, method):
    results = []
    for i in range(file_amount):
        ...
        score = loading_data(train_string, test_string, _epochs, method)
        results.append(score)

    return results


def loading_data(_train, _test, _epochs, method):
...
score = merging_k_fold(k_fold_amount, epochs, "bnb")
print(score)
avg_result = 0
