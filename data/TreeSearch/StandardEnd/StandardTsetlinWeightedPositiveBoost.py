...
#tsetlinStandardWeightedHandler(500, 15000, 28000, 20, k_fold_amount)
#tsetlinStandardWeightedHandler(500, 15000, 28000, 30, k_fold_amount)
#tsetlinStandardWeightedHandler(500, 15000, 28000, 40, k_fold_amount)

tsetlinStandardWeightedHandler(500, 10, 10, 40, k_fold_amount)
