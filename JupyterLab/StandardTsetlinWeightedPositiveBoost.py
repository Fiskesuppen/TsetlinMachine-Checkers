...
base_path_start = "Data/StandardEnd/"
...
tsetlinStandardWeightedHandler(500, 15000, 12000, 1, k_fold_amount)
tsetlinStandardWeightedHandler(500, 15000, 12000, 15, k_fold_amount)
tsetlinStandardWeightedHandler(500, 15000, 12000, 30, k_fold_amount)
tsetlinStandardWeightedHandler(500, 15000, 12000, 40, k_fold_amount)
tsetlinStandardWeightedHandler(500, 15000, 12000, 60, k_fold_amount)
tsetlinStandardWeightedHandler(500, 15000, 12000, 80, k_fold_amount)
